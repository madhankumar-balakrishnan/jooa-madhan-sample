...
CREATE TABLE `author_book` (
  ...
  CONSTRAINT `fk_ab_author` FOREIGN KEY (`author_id`) REFERENCES `author` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `author_book` VALUES (1,1),(2,1),(1,3);
...
-- Dump completed on 2017-07-22  0:58:57
